...
import bg_landingpage from "./images/bg_landingpage.jpg";
        ...
        <ScrollAnimation animateIn="fadeIn" animateOut="fadeOut">
          ...
          >
            <Container text textAlign="left" className="showcase-content">
              ...
              >
                <span class="showcase-title first-word"> Expanding </span>{" "}
                <span class="showcase-title second-word"> Possibilities. </span>
              </ScrollAnimation>
              <ScrollAnimation
                animateIn="fadeInLeft"
                animateOut="fadeOutRight"
