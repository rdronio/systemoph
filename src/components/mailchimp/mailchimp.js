...
const url = "//systemoph.us4.list-manage.com/subscribe/post?u=83e019efd7d7d0a82d55147a0&amp;id=d23019694a";
            ...
            <Segment className="mailchimp" vertical textAlign='center' style={{
                ...
                <MailchimpSubscribe
                    ...
                    <div className="mailchimp-content">
                        <div className="mailchimp-title"> Subscribe to our newsletter and stay updated. </div>
                        <SimpleForm  onSubmitted={formData => subscribe(formData)}/>
                        {status === "sending" && <div style={{ color: "blue" }}>sending...</div>}
                        {status === "error" && <div style={{ color: "red" }} dangerouslySetInnerHTML={{__html: message}}/>}
                        {status === "success" && <div style={{ color: "green" }}>Subscribed !</div>}
                        <div className="mailchimp-social">
                            <Image src={facebookImg} className="mailchimp-facebook" href='http://facebook.com/systemoph'/>
                            <Image src={linkedinImg} className="mailchimp-linkedin" href='http://linkedin.com'/>
                        </div>
                    </div>
                    )}
                />
