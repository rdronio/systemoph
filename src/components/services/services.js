                ...
                <Grid stackable columns={2}>
                  ...
                  >
                    <div>
                      ...
                      <div className="service-desc">
                        {" "}
                        an application program that is stored on a remote server
                ...
                <Grid stackable columns={2}>
                  ...
                  >
                    <div>
                      ...
                      <div className="service-desc">
                        {" "}
                        is installed and runs on computers on the premises of
                        the person or organization using the software, rather
                        than at a remote facility such as a server farm or
                        cloud.{" "}
                      </div>
                    </div>
                  </Grid.Column>
                ...
                <Grid stackable columns={2}>
                  ...
                  >
                    <div>
                      ...
                      <div className="service-desc">
                        {" "}
                        refers to the physical elements that make up a computer
                        or electronic system and everything else involved that
                ...
                <Grid stackable columns={2}>
                  ...
                  >
                    <div>
                      ...
                      <div className="service-desc">
                        {" "}
                        business practice of hiring a party outside a company to
                        perform services and create goods that traditionally
                        were performed in-house by the company's own employees
                        and staff.{" "}
                      </div>
                    </div>
                  </Grid.Column>
